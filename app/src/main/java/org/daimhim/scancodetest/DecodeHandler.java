...
final class DecodeHandler extends Handler {
    ...
    DecodeHandler(IScanCode pIScanCode, Map<DecodeHintType, Object> hints) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        PlanarYUVLuminanceSource source = mIScanCode.getCameraManager()
        ...
        Handler handler = mIScanCode.getHandler();
        if (rawResult != null) {
